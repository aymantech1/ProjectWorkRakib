			...
			<div class="row">
				...
				<nav class="col-lg-9 col-md-12 col-lg-pull-0 col-md-pull-1 mainmenu-container">
					...
					<ul class="mainmenu pull-right">
						...
						<li><a href="faq.html" class="hvr-overline-from-left">FAQ</a></li>
					</ul>
				</nav>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<div class="page-breadcumb pull-right">
						<i class="fa fa-home"></i> <a href="index.html">Home</a> <i class="fa fa-angle-right"></i> <span>404 Page</span>
					</div> <!-- /.page-breadcumb -->
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-7 col-md-7 col-sm-9 col-xs-12 col-lg-offset-5 col-md-offset-5 col-sm-offset-2">
					...
					<a href="#" class="button-404 hvr-bounce-to-right">Go To Home</a>
				</div>
			</div>
		</div>
	</section>
