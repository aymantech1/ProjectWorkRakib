...
$singleUser = $user->prepare($_GET)->editProfileByUniqueID();
...
<head>
    ...
    <title>OWN CMS | Edit Profile</title>
                    ...
                    <div class="box">
                        ...
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title"><?php echo $singleUser['username']; ?></h3>
                            </div><!-- /.box-header -->
                            <!-- form start -->
                            <form role="form" action="user-profile-update-process.php" method="post">
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <input
                                            ...
                                            class="form-control"
                                            id="firstName"
                                            value="<?php echo  $singleUser['first_name']; ?>">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input
                                            ...
                                            class="form-control"
                                            id="lastName"
                                            value="<?php echo $singleUser['last_name']; ?>">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input
                                            ...
                                            id="username"
                                            disabled
                                            value="<?php echo $singleUser['username']; ?>">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input
                                            ...
                                            id="email"
                                            disabled
                                            value="<?php echo $singleUser['email']; ?>">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input
                                            ...
                                            class="form-control"
                                            id="pPhone"
                                            value="<?php echo $singleUser['personal_phone']; ?>">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input
                                            ...
                                            class="form-control"
                                            id="hPhone"
                                            value="<?php echo $singleUser['home_phone'];  ?>">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input
                                            ...
                                            class="form-control"
                                            id="oPhone"
                                            value="<?php echo $singleUser['office_phone'];  ?>">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input
                                            ...
                                            class="form-control"
                                            id="cAddr"
                                            value="<?php echo $singleUser['current_address'];  ?>">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input
                                            ...
                                            class="form-control"
                                            id="pAddr"
                                            value="<?php echo $singleUser['permanent_address']; ?>">
                                    </div>

                                    <div class="form-group">
                                        <label for="pPic">File input</label>
                                        <input
                                            type="file"
                                            id="pPic">
