                ...
                <?php
                  ...
                  foreach ($allUsers as $singleUser) {
                    ...
                    <tr>
                      ...
                      <td><?php echo $singleUser['signUpDate']; ?></td>
                      <td>
                        <a
                            href="user-profile.php?unique_id=<?php echo $singleUser['unique_id']; ?>"
                            title="view"
                            data-toggle="tooltip">
                          <i class="fa fa-eye"></i>
                        </a>
                        <a
                            href="user-profile-edit.php?unique_id=<?php echo $singleUser['unique_id']; ?>"
                            title="edit"
                            data-toggle="tooltip">
