...
if (isset($_FILES['image_name']['name']) && !empty($_FILES['image_name']['name'])) {
    ...
    if (empty($errors) == true) {
        move_uploaded_file($tmpName, '../assets/img/post/' . $fileName);
        $_POST['image_name'] = $fileName;
    } else {
        print_r($errors);
    }
...
$user->prepare($_POST)->postArticle($sID);
                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        ...
                        <div class="box-body pad">
                            <form action="post-new-process.php" method="post">
