...
$id= $_GET['id'];
$singleCategory = $user->getSingleCategory($id);

// echo "<pre>";
// print_r($singleCategory[0]['title']);
// echo "</pre>";
// die();
                        ...
                        <div class="box-body pad">
                          <form action="category-update-process.php" method="post">
                              <div class="form-group">
                                  <input type="hidden" name="id" value="<?php echo $singleCategory[0]['id']?>">
                                  <label for="category">Add Category</label>
                                  <input name="title"type="text" class="form-control" id="category" value="<?php echo $singleCategory[0]['title']?>">
                              </div>
