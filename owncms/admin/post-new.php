...
$allcategorydata = $user->allcategorydata();
                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        ...
                        <div class="box-body pad">
                            <form action="post-new-process.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div style="margin-top: 50px">
                                        <div class="col-md-2 col-md-offset-1">
                                            ...
                                            <div class="form-group">
                                              ...
                                              <select class="form-control" id="inputCategory" name="category_name" type="text">

                                                <?php foreach($allcategorydata as $singleCategoryData) {?>
                                                   <?php echo "<option>";
                                                         echo $singleCategoryData['title'];
                                                         echo "</option>";
                                                   ?>
                                                 <?php }?>
                                              </select>
                                            ...
                                            <br><button
                                                type="submit"
                                                class="btn btn-default btn-lg">Publish
                                            </button>
                                        </div>
                                    </div>
